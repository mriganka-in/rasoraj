    ...
    <div className="flex justify-center gap-15 px-6 py-6">
        ...
        <span className="flex flex-col gap-2">
            ...
            <span className="flex items-center space-x-2">
                <select defaultValue={"1kg"} className="flex justify-center border border-gray-300 h-10 w-36 px-3  py-1 rounded-md focus:outline-none">
                    <option>250g</option>
                    <option>500g</option>
                    <option >1kg</option>
                    <option>2kg</option>
        ...
        <span className="flex flex-col gap-2">
            ...
            <span className="flex items-center space-x-2">
                <select defaultValue={"₹10"} className="flex justify-center border border-gray-300 h-10 w-36 px-3  py-1 rounded-md focus:outline-none">
                    <option>₹8</option>
                    <option>₹10</option>
                    <option>₹15</option>
                    <option>₹18</option>
